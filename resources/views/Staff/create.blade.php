...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <div class="mb-6">
                <h3 class="text-xl font-semibold text-gray-900 mb-2">Informasi Karyawan</h3>
                <p class="text-sm text-gray-500">Lengkapi form di bawah ini untuk menambahkan karyawan baru</p>
            </div>
            ...
            <form method="POST" action="{{ route('staff.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <select id="role" 
                        ...
                        <option value="staff" {{ old('role') == 'staff' ? 'selected' : '' }}>Karyawan</option>
